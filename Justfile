...
prompt-eval-core runs="1" timeout_secs="60":
    cargo run --bin glide-bench -- prompt-eval --suite "{{ROOT}}/fixtures/prompt_eval/core.jsonl" --candidate "openai:gpt-5.4-nano" --candidate "groq:llama-3.3-70b-versatile" --candidate "cerebras:gpt-oss-120b" --candidate "fireworks:accounts/fireworks/models/gpt-oss-20b" --runs "{{runs}}" --timeout-secs "{{timeout_secs}}"
