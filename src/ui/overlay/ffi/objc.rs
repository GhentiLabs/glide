pub(in crate::ui::overlay) use std::ffi::c_void;
use std::ffi::{CStr, c_char};

pub(in crate::ui::overlay) const NOTCH_WIDTH_FALLBACK: u32 = 180;
pub(in crate::ui::overlay) const NOTCH_HEIGHT_FALLBACK: f64 = 37.0;
pub(in crate::ui::overlay) const NOTCH_HEIGHT: f64 = 60.0;
pub(in crate::ui::overlay) const NOTCH_CORNER_RADIUS: f64 = 10.0;
pub(in crate::ui::overlay) const NOTCH_BAR_COUNT: usize = 16;
pub(in crate::ui::overlay) const NOTCH_BAR_GAP: f64 = 2.0;
pub(in crate::ui::overlay) const NOTCH_BAR_WIDTH: f64 = 4.0;
pub(in crate::ui::overlay) const NOTCH_DOT_COUNT: usize = 3;
pub(in crate::ui::overlay) const NOTCH_DOT_GAP: f64 = 8.0;
pub(in crate::ui::overlay) const NOTCH_DOT_SIZE: f64 = 6.0;
pub(in crate::ui::overlay) const NOTCH_BAR_TOP_INSET: f64 = 6.0;
pub(in crate::ui::overlay) const NOTCH_BAR_MAX_HEIGHT: f64 = 40.0;
pub(in crate::ui::overlay) const NOTCH_DOT_BOTTOM_INSET: f64 = 12.0;

pub(in crate::ui::overlay) const GLOW_PADDING: f64 = 144.0;
pub(in crate::ui::overlay) const GLOW_AURA_SIZE: f64 = 136.0;
pub(in crate::ui::overlay) const GLOW_AURA_SCALE_X: f64 = 1.75;
...
unsafe extern "C" {
    pub(in crate::ui::overlay) fn objc_getClass(name: *const c_char) -> *mut c_void;
    pub(in crate::ui::overlay) fn sel_registerName(name: *const c_char) -> *mut c_void;
    pub(in crate::ui::overlay) fn objc_msgSend(
        receiver: *mut c_void,
        sel: *mut c_void,
    ) -> *mut c_void;
}
...
pub(in crate::ui::overlay) struct NSRect {
    pub(in crate::ui::overlay) x: f64,
    pub(in crate::ui::overlay) y: f64,
    pub(in crate::ui::overlay) w: f64,
    pub(in crate::ui::overlay) h: f64,
}
